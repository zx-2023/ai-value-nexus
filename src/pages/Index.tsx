  ...
  const benefits = [
    {
      icon: Zap,
      title: '提升效率',
      description: 'AI 驱动的智能匹配，平均节省 70% 的筛选时间',
    },
    {
      icon: Shield,
      title: '降低风险',
      description: '沙箱验证机制，项目成功率提升至 95%',
    },
    {
      icon: Globe,
      title: '全球协作',
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
            重新定义
            <span className="text-primary"> 企业与开发者 </span>
            的协作方式
          </h1>
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            通过 AI 驱动的需求分析、智能人才匹配和实时能力验证，
            我们为您构建了一个基于信任的价值交付网络。
          </p>
