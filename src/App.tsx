...
import MarketDemandPage from './pages/market-demand/MarketDemandPage';
...
import AIResumePage from './pages/ai-resume/AIResumePage';
        ...
        <BrowserRouter>
          <div className="min-h-screen bg-background">
            ...
            <Routes>
              ...
              <Route path="/market-demand" element={<MarketDemandPage />} />
